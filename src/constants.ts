...
export const QUESTS: Quest[] = [
  ...
  // 工坊清单 (Artisan/Labor)
  { id: 'l1', type: 'labor', categoryName: '工坊清单', targetLv: 1, title: '学徒绕线', description: '帮工坊绕线 1 小时。工坊的繁荣离不开你的勤勉。', ycReward: 50, insReward: 100, rewardText: '100 创意', purpose: '工匠流' },
  { id: 'l2', type: 'labor', categoryName: '工坊清单', targetLv: 2, title: '草莓叶愿望', description: '制作 10 片绿色的草莓叶子。工坊需要它们装点作品。', ycReward: 100, insReward: 300, rewardText: '300 创意 + 100 YC', purpose: '半成品储备' },
  { id: 'l3', type: 'labor', categoryName: '工坊清单', targetLv: 3, title: '素体养成', description: '制作 20 个玩偶头部（白球）。这是店里最缺的基础。', ycReward: 300, insReward: 800, rewardText: '800 创意 + 300 YC', purpose: '核心组件' },
  
  // 限定通告 (Collector/Patron)
  { id: 'p1', type: 'patron', categoryName: '限定通告', targetLv: 1, title: '初遇礼包', description: '购买精选新手材料礼包，瞬间点亮创意。', ycReward: 0, insReward: 100, cost: 168, rewardText: '100 创意', purpose: '收藏家' },
  { id: 'p2', type: 'patron', categoryName: '限定通告', targetLv: 4, title: '闺蜜下午茶', description: '邀请一位新朋友完成体验课，共享织梦时光。', ycReward: 500, insReward: 1000, rewardText: '1000 创意 + 500 YC', purpose: '社交裂变' }
];
